...
class GroupCreationController: UIViewController,UIPickerViewDataSource, UITextFieldDelegate,UIPickerViewDelegate
{
  ...
  override func viewDidLoad() {
    ...
    //Set the current date and time to the pickers 
    ...
    self.time.text = timeFormatter!.stringFromDate(timePicker.date)
    self.date.text = timeFormatter!.stringFromDate(datePicker.date)
  }
