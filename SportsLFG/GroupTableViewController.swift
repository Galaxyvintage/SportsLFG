...
class GroupTableViewController: UITableViewController
{
    ...
    var dataLimit = 10 //loads 20 groups max each time
    var dataSkip  = 0 //skips 20 groups after loading the first time
    var lastItemReached = false //checks if the table view has reached the last itme
